...
export default function AgentIntroSection({ settings = {} }: Props) {
  ...
  const agentBody = settings.about_agent_body || "English Gate는 2015년부터 필리핀 어학연수를 전문으로 하는 에이전시입니다. 바기오, 세부, 마닐라 등 필리핀 전 지역의 어학원과 직접 파트너십을 맺어 최적의 조건으로 연수를 도와드립니다.";
  let agentItems: string[] = ["10년+ 필리핀 현지 네트워크", "무료 맞춤 상담 서비스", "현지 24시간 긴급 지원"];
  try {
  ...
  const locationBody = settings.about_location_body || "한국 서울 사무소와 필리핀 현지 파트너 사무소를 통해 출국 전부터 귀국까지 원스톱 서비스를 제공합니다.";
  ...
  const contactBody = settings.about_contact_body || "언제든지 편하게 연락주세요. 카카오톡, 전화, 이메일 등 다양한 채널을 통해 빠른 답변을 드립니다.";
    ...
    <section id="about" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <p className="text-blue-600 font-semibold text-sm uppercase tracking-widest mb-2">About Us</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">{agentBody}</p>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">{locationBody}</p>
            <div className="bg-gradient-to-br from-blue-50 to-green-50 rounded-xl p-4 border border-gray-100">
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-xs">{krAddress}</p>
                    <p className="text-gray-500 text-xs">{krHours}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-xs">{phAddress}</p>
                    <p className="text-gray-500 text-xs">{phHours}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">{contactBody}</p>
            <div className="space-y-3">
              <a
                href={`tel:${phone}`}
